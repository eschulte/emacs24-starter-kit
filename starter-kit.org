...
- ELPA archive repositories and two packages to install by default.
  #+begin_src emacs-lisp
    ...
    (defvar starter-kit-packages
      ...
      ;; Unfortunately 'color-theme in marmalade is broken in marmalade.
      ;; In the interum You can download a working color-theme.el from
      ;; http://download.savannah.gnu.org/releases/color-theme/ and unpack
