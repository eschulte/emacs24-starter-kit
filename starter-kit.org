...
#+begin_src emacs-lisp 
  (setq starter-kit-dir (file-name-directory
                      (or load-file-name (buffer-file-name))))
  
  (add-to-list 'load-path starter-kit-dir)
  (add-to-list 'load-path (concat starter-kit-dir "/elpa-to-submit"))
  (add-to-list 'load-path (concat starter-kit-dir "/elpa-to-submit/jabber"))
...
#+begin_src emacs-lisp 
  (setq system-specific-config (concat starter-kit-dir system-name ".el")
