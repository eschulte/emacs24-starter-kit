...
1. Install Emacs version 24 or greater.  Use your package manager if
   you have one and it has a version of Emacs 24, otherwise install it
   directly [[http://savannah.gnu.org/projects/emacs/][from source]].
...
installed through ELPA will be stored in the =elpa= directory.
...
** Optional Language/Mode Specific Files
...
#+begin_src emacs-lisp
  (flet ((in-kit (file ext) (expand-file-name (concat file ext) starter-kit-dir)))
...
*** Add the =src= dir to the load path
