...
- ELPA archive repositories and two packages to install by default.
  #+begin_src emacs-lisp
    ...
    (defvar starter-kit-packages
      ;; Yasnippet-bundle is old and conflicts with django-html-mumamo-mode.
      ;; Others may not use this mode, but it is crippling when the bug
      ;; occurs, requiring one to restart emacs and break work flow when it
      ;; comes up.
